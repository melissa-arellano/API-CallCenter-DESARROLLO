...
// var err = AnsweredCallsImplementation.put(service,day,country,from,to,threshold);
...
exports.put = function (service, day, country, from, to, threshold) {
  return new Promise((resolve, reject) => {
    ...
    console.log("\n ---> ENTRANDO A ANSWER CALLS IMPLEMENTATION ");
    ...
    // FUNCION PARA ENVIAR LOS DATOS EN EL ARREGLO []
